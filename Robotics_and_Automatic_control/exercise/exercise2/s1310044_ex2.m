%
%   Simulation of dc_motor P-control
...
title('DC motor angular speed by P-control: k = 1.0');
...
plot(t, Y_G2_X10, 'r-');
xlim([0 1]); ylim([0 1200]);
title('DC motor angular speed by P-control: k = 0.1');
legend('x = 1000')
...
% % Plot for c = 0.01
% figure(2);
% % plot(t, Y_G2_X3, 'r-', t, Y_G2_X6, 'g-', t, Y_G2_X9, 'b-');
% plot(t, Y_G2_X3, 'r-',  t, X3, 'k-', t, ...
%     Y_G2_X6, 'g-',  t, X6, 'k-', ...
%     t, Y_G2_X9, 'b-',  t, X9, 'k-');
% xlim([0 1]); ylim([0 1200]);
% title('DC motor angular speed by P-control: k = 0.01');
...
% % Plot for c = 0.001
% figure(3);
% % plot(t, Y_G3_X3, 'r-', t, Y_G3_X6, 'g-', t, Y_G3_X9, 'b-');
% plot(t, Y_G3_X3, 'r-',  t, X3, 'k-', t, ...
%     Y_G3_X6, 'g-',  t, X6, 'k-', ...
%     t, Y_G3_X9, 'b-',  t, X9, 'k-');
% xlim([0 1]); ylim([0 1200]);
% title('DC motor angular speed by P-control: k = 0.001');
...
% Plot for x = 1000
figure(5);
plot(t, Y_G1_X10, 'r-', t, Y_G2_X10, 'g-', t, Y_G3_X10, 'b-', t, Y_G4_X10, 'm-', t, X10, 'k-');
xlim([0 1]); ylim([0 1200]);
title('DC motor angular speed by P-control for x = 1000');
legend('k = 1.0', 'k = 0.1', 'k = 0.01', 'k = 0.001');
...
% xlim([0 0.0002]); ylim([0 1800]);
% title('DC motor angular speed by P-control for x = 900');
